...
int main(){
    ...
    soma=soma_min_max(&min,&max);//alterar� as vari�veis, passagem por refer�ncia usando ponteiro, LEMBRA DO & para amarrar o endere�o da vari�ve�
...
int main() {
    ...
    printf("\n\nODRDEM CRESCENTE:\n");
    ordenar_crescente(&vetor,n); //o nome do vetor � o mesmo que o endere�o do primeiro elemento do vetor(vetor == vetor[0]
...
void transformar_camelcase(char *ptr){ //Aula de IC (1� caracter e caracteres depois do expa�o)
for(int i=0;ptr[i]!='\0';i++){
    if(ptr[i] == ' '){
